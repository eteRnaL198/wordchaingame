  ...
  <div className="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0 h-1/10">
    <div className="relative flex">
      <input
        ...
        value={inputWord}
      />
      <button type="button" onClick={() => handlePlayerWordAdd(inputWord)} className="inline-flex items-center justify-center rounded-full h-12 w-16 transition duration-500 ease-in-out text-white bg-blue-500 hover:bg-blue-400 focus:outline-none">
