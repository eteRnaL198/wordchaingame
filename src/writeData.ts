...
const writeData = () => {
    (async () => {
        ...
        await db.collection("words").add({
          ...
          い: [{desc:"言い伝え",word:"いいつたえ"},{desc:"言い訳",word:"いいわけ"},{desc:"委員会",word:"いいんかい"},{desc:"委員長",word:"いいんちょう"},{desc:"家",word:"いえ"},{desc:"胃液",word:"いえき"},{desc:"家出",word:"いえで"},{desc:"硫黄",word:"いおう"},{desc:"イカ",word:"いか"},{desc:"胃潰瘍",word:"いかいよう"},{desc:"医学",word:"いがく"},{desc:"如何様",word:"いかさま"},{desc:"胃下垂",word:"いかすい"},{desc:"雷",word:"いかずち"},{desc:"烏賊墨",word:"いかすみ"},{desc:"筏",word:"いかだ"},{desc:"いかフライ",word:"いかふらい"},{desc:"胃カメラ",word:"いかめら"},{desc:"イカ焼き",word:"いかやき"},{desc:"錨",word:"いかり"},{desc:"イカリング",word:"いかりんぐ"}],
